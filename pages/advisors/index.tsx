...
const contents: AdvisorModel[] = [
  {
    ...
    country: "Italy",
    title: "Founder & Managing Partner of Italian Fit Out SRL",
    description:
  ...
  },
  {
    ...
    country: "Singapore",
    title:
      "Certified Green Mark Manager, Universal Design Assessor and Design for Safety Professional, General Director at RSP Vietnam.",
    description:
  ...
  },
  {
    ...
    country: "Singapore",
    title: "Chief Corporate Officer at Chiu Teng Group (CTC), Singapore",
    description:
  ...
  },
  {
    ...
    country: "Thailand",
    title: "Founder of PAD Space Artisan, Award-winning company, Thailand",
    description:
  ...
  },
  {
    ...
    country: "Vietnam",
    title:
      "CEO, Founder of Vietnam Design & Build Center, COO of Asia Awards Organization",
    description:
  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <ContentCard title={"\\\nTHE ADVISORS"}>
          <p>
            The Board of Advisors comprises accomplished professionals from
            various industries and diverse backgrounds, each possessing
            substantial experience in fields like real estate development,
            architecture, hospitality, media, and academia.
          </p>
          <p>
            Their impressive expertise in their respective domains empowers us
            to offer a broad spectrum of plans that align with the expectations
            of our partners.
          </p>
        </ContentCard>
        ...
        <div className={styles.advisors}>
          {contents.map((item, index) => (
            <AdvisorItem key={item.name} {...item} rtl={index % 2 == 0} />
          ))}
        </div>
      </main>
      <footer className={styles.footer}>
        <AdvisorsFooterBanner className={styles.footerBanner} />
        <Footer />
      </footer>
    </div>
  );
